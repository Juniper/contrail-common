...
public:
    ...
    static void set_sample_logger_appender(const std::string &file_name,
                             long max_file_size,
                             int maxBackupIndex,
    ...
    static void set_slo_logger_appender(const std::string &file_name,
                             long max_file_size,
                             int maxBackupIndex,
                             const std::string &syslogFacility,
                             const std::vector<std::string> &slo_destn,
                             const std::string &ident);
    static void set_send_2_collector_flags(
                             const std::vector<std::string> &sample_destn,
                             const std::vector<std::string> &slo_destn);
    static void set_send_2_logger_flags(
                             const std::vector<std::string> &sample_destn);
    static bool is_send_slo_collector_enabled() { return slo_2_collector_; }
    static bool is_send_sampled_2_collector_enabled() { return sample_2_collector_; }
    static bool is_send_slo_2_logger_enabled() { return slo_2_logger_; }
    static bool is_send_sampled_2_logger_enabled() { return sample_2_logger_; }
...
private:
    ...
    static bool slo_2_collector_;
    static bool sample_2_collector_;
    static bool slo_2_logger_;
    static bool sample_2_logger_;
};
