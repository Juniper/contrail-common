...
func InterfaceToKubernetesCluster(iData interface{}) *KubernetesCluster {
	...
	return &KubernetesCluster{
		...
		//{"Title":"Kuberunetes Dashboard","Description":"","SQL":"varchar(255)","Default":"","Operation":"","Presence":"","Type":"string","Permission":["create","update"],"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"kuberunetes_dashboard","Item":null,"GoName":"KuberunetesDashboard","GoType":"string"}
