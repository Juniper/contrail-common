...
public:
     ...
     */
    EtcdIf(const string host, const int port, bool useSsl);
     ...
     */
    EtcdResponse Get(const string& key,
     ...
     * @param range_end The key range to fetch
     */
    void Delete(const string& key, const string& range_end);
     ...
     */
    void Watch(const string& key, WatchCb cb);
