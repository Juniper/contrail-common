...
public:
     ...
     */
    EtcdIf(const vector<string> &etcd_hosts,
...
private:
    ...
    int port_;
    bool useSsl_;
    unique_ptr<KV::Stub> kv_stub_;
    unique_ptr<Watch::Stub> watch_stub_;
    ...
    struct EtcdAsyncGetCall : public EtcdAsyncCall {
        unique_ptr<ClientAsyncResponseReader<RangeResponse>> get_reader_;
        int gtag_;
    ...
    struct EtcdAsyncSetCall : public EtcdAsyncCall {
        unique_ptr<ClientAsyncResponseReader<PutResponse>> set_reader_;
    ...
    struct EtcdAsyncDeleteCall : public EtcdAsyncCall {
        unique_ptr<ClientAsyncResponseReader<DeleteRangeResponse>> delete_reader_;
    ...
    struct EtcdAsyncWatchCall : public EtcdAsyncCall {
        unique_ptr<ClientAsyncReaderWriter<WatchRequest,WatchResponse>> watch_reader_;
        bool watch_active_;
        int wtag;
...
class EtcdResponse {
public:
    typedef multimap<string, string> kv_map;
