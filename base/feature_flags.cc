...
#ifdef _WIN32
#define FLAG_DEBUG(...) if (process::debug_) LOG(DEBUG, ##__VA_ARGS__)
#define FLAG_WARN(...) if (process::debug_) LOG(WARN, ##__VA_ARGS__)
#define FLAG_ERROR(...) if (process::debug_) LOG(ERROR, ##__VA_ARGS__)
#else
...
/**
 * ---------------------------------------------
 * FlagUveManager Class Method Definitions
 * ----------------------------------------------
 */
...
/**
 * -------------------------------------
 * FlagManager Class Method Definitions
 * --------------------------------------
 */
...
int FlagManager::GetFlagMapCount() const {
...
int FlagManager::GetIntMapCount() const {
